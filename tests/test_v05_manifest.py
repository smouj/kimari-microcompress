...
class TestManifestV4:
    ...
    def test_manifest_version_is_7(self):
        """KMC_MANIFEST_VERSION is 7 for v0.8."""
    ...
    def test_tool_version_is_0_8(self):
        """Tool version is 0.8.0-alpha."""
        m = KMCManifest()
        assert m.tool_version == "0.8.0-alpha"
